...
export let writeConnection: WriteConnection = {} as WriteConnection;
export let readConnection: ReadConnection = {} as ReadConnection;
...
export const ENTITY_ID_TRANSFORMER: string = 'EntityIdTransformer';
